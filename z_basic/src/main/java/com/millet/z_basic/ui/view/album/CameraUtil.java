...
import com.millet.z_basic.base.BaseConst;
...
public class CameraUtil {
        ...
        AndPermission.with(activity)
                ...
                .onGranted(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> data) {
                        ...
                        activity.startActivityForResult(intent, BaseConst.REQUEST_CODE_TAKE_PHOTO);
                    }
                })
        ...
        AndPermission.with(fragment)
                ...
                .onGranted(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> data) {
                        ...
                        intent.putExtra(MediaStore.Images.Media.ORIENTATION, 0);
                        fragment.startActivityForResult(intent, BaseConst.REQUEST_CODE_TAKE_PHOTO);
                    }
                })
                .onDenied(new Action<List<String>>() {
                    @Override
    ...
    public static File getImageFile(String name) {
        return new File(BaseConst.PIC_PATH, name);
    }
...
//        intent.putExtra("scale",true);//自由截取
        ...
        activity.startActivityForResult(intent, BaseConst.REQUEST_CODE_CROP_PHOTO);
    }
